...
$g_arrayHireRoom = [
	...
	function DoGenerateSourceCodeContent()
	{
		...
		echo "<h2>WEBSITE</h2>\n";
		echo "\n";
		echo "		<p>The source code for the website is located on <a href=\"https://github.com\">GitHub</a>.</p>\n";
		echo "\n";
		echo "		<p><b>ACCOUNT NAME: </b>MillhouseMaryboroughVIC</p>\n";
		echo "		<p><b>PASSWORD: </b>Click the button and the password will be emailed to the Mill House manager.</p>\n";
		echo "		<form method=\"post\" action=\"index.php\" target=\"_self\">\n";
		echo "			<input type=\"submit\" name=\"submit_email_github_password\" value=\"EMAIL GITHUB ACCOUNT PASSWORD\" />\n";
		echo "		</form>\n";
		echo "\n";
		echo "		<p><b>REPOSTORY NAME: </b>Millhouse-Website</p>\n";
		echo "\n";
		echo "		<p>This repository is intended as the working repository.</p>\n";
		echo "\n";
		echo "		<p>The latest website code should be kept in this repository.</p>\n";
		echo "\n";
		echo "		<p><b>BACKUP REPOSTORY NAME: </b>Millhouse-Website-Backup</p>\n";
		echo "\n";
		echo "		<p>The backup respository is intended as a fall back in case any future web administrators muck up the website \n";
		echo "		code and cannot recover.</p>\n";
		echo "\n";
		echo "		<p>It should ONLY be updated from <i>Millhouse-Website</i> if the future web adminstrator is ABSOLUTELY sure \n";
		echo "		that their code changes are SOUND.</p>\n";
		echo "\n";
		echo "<h3>GitHub Desktop</h3>\n";
		echo "\n";
		echo "<p>Don't bother trying to do all the this directly in through the GitHub website - it is a pain in the arse.</p>\n";
		echo "\n";
		echo "<p>Instead download and install <a href=\"https://github.com\">GitHub Desktop</a></p>\n";
		echo "\n";
		echo "<p>This software allows you to connect to your GitHub account and the respositories in it. It automatically detects \n";
		echo "changes in your source code and allows you to update your respository source code. It is quite easy to use.</p>\n";
		echo "\n";
		echo "<p>Follow this <a href=\"https://github.com\">guide</a> \n";
		echo "to connect GitHub Desktop to the above GitHub account.</p>\n";
		echo "\n";
		echo "<p>Follow this <a href=\"https://github.com\">guide</a> \n";
		echo "to clone the GitHub 'Millhouse-Website' respository to your hard drive.</p>\n";
		echo "\n";
		echo "<p>Follow this <a href=\"\">guide</a> to sychronise the GitHub 'Millhouse-Website' respository with code changes you have made on your hard drive.</p>\n";
		echo "\n";
		echo "<p>GitHub Desktop is quite intuituve to use.</p>\n";
		echo "\n";
		echo "<p>\n";
		echo "	The key advantage of Expression web is that it highlights the that part of the code in a web page, that is controlled \n";
		echo "	by the template file 'master.dwt', with a yellowish background. That is a warning to not edit this part of the web page \n";
		echo "	code as you risk breaking the overall structure of the web page. If you edit the code in Notepad++ then you will not get \n";
		echo "	this warning. So I strongly urge you to use MS Expression Web to edit code in this website. You can read more details \n";
		echo "	about this by clicking the 'Page editing sinstructions' buttons on any of the web pages. But you must be logged in as \n";
		echo "	admininstrator to see those button.\n";
		echo "</p>\n";
		echo "\n";
		echo "<p>&nbsp;</p>\n";
		echo "\n";
		echo "<h3>Strange folders</h3>\n";
		...
		echo "\n";
		echo "<p>The app was created with <a href=\"https://mit.edu\">MIT App Inventor</a>. Click 'Create Apps!' and \n";
		echo "register your own account.</p>\n";
		echo "\n";
		echo "<p>The screens are designed via a drag and drop system.<br/>\n";
		echo "<a href=\"images/MITAppInventorScreenDesign.jpg\"><img src=\"images/MITAppInventorScreenDesign.jpg\" alt=\"MITAppInventorScreenDesign.jpg\" height=\"300\" /></a></p>\n";
		echo "\n";
		echo "<p>The coding is block based and easy to get the hang of than text coding with its syntax errors.<br/>\n";
		echo "<a href=\"images/MITAppInventorBlockCoding.jpg\"><img src=\"images/MITAppInventorBlockCoding.jpg\" alt=\"MITAppInventorBlockCoding.jpg\" height=\"300\" /></a></p>\n";
		echo "\n";
		echo "<p>The source code is contained in the file <a href=\"MobileApp/Mill_House.aia\">Mill_House.aia</a>, which is located in \n";
		echo "the website folder 'MobileApp'.</p>\n";
		echo "\n";
		echo "<p>This is a binary file so you can't red the code in a text editor. You import this file into your MIT App Inventor account as \n";
		echo "a new project. Then you will be able to edit the screens and the blocks.</p>\n";
		echo "\n";
		echo "<p>You will probably find that Chrome or Firefox web browsers will 'choke' on the Mill House app project when you \n";
		echo "try to load it in your MIT App Inventor account. Instead use Opera web browser.</p>\n";
		echo "\n";
		echo "<p>The APK Android installation package is the file <a href=\"MobileApp/Mill_house.apk\">Mill_house.apk</a>. The website contains a hyperlink to this file to \n";
		echo "allow users to download and install the app on their Android phone.</p>\n";
		echo "\n";
		echo "<h2>THE DATABASE</h2>\n";
		echo "\n";
		echo "<p>The database was created with <a href=\"https://mysql.com\">MySQL Workbench</a></p>\n";
		echo "\n";
		echo "<p>Follow this <a href=\"https://mysql.com\">\n";
		echo "guide</a> to connect MySQL Workbench running on your PC to the database at millhouse.org.au.</p>\n";
		echo "\n";
		echo "<p>If you ever need to re-build the database then there are self contained SQL files located in the website folder \n";
		echo "'MySQL'. You can import these files into MySQL Workbenech and phpMyAdmin in cPanel of web hosting acctoung, and \n";
		echo "re-generate the entire database - both tables and their contents. These files should be kept up to date with the \n";
		echo "rest of the source code.</p>\n";
		echo "\n";
