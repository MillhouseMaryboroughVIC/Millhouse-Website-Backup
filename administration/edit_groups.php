...
*/
	...
	function DoDisplayGroupEditForm()
	{
		...
		echo "        <tr><td>&nbsp;</td></tr>\n";
		echo "        <tr>\n";
		echo "	          <td style=\"text-align: right;width:48ch;\"><label for=\"name\">Group ID (short): </label></td>\n";
		...
		echo "        </tr>\n";
		echo "        <tr>\n";
		echo "	          <td style=\"text-align: right;\"><label for=\"description\">Group Name (for display): </label></td>\n";
		...
		echo "	          <td><input name=\"contact\" id=\"contact\" type=\"text\" pattern=\"" . $g_strPatternPersonName . ">\" autocomplete=\"on\" maxlength=\"90\" value=\"" . $_SESSION["contact"] . "\" placeholder=\"Group leader's name...\"onkeydown=\"OnKeyPressName(event)\" /></td>\n";
		echo "        </tr>\n";
		echo "        <tr>\n";
