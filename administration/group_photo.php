<?php
	...
	function DoDisplayGroupPhotoForm()
	{
		...
		echo "				<button type=\"button\" aria-label=\"Click this button to change the image height.\" id=\"button_change_image_size\" disabled onclick=\"DoChangeImageSize()\">CHANGE IMMAGE SIZE</button>\n";
		echo "			</td>\n";
		echo "		</tr>\n";
		echo "		<tr>\n";
		echo "			<td style=\"text-align:right;\">\n";
		...
		echo "				<button type=\"button\" aria-label=\"Click this button to add a new moveable and resizeable selection square.\" id=\"button_new_area_square\" disabled onclick=\"DoAddAreaSquare()\">CREATE NEW AREA SQUARE</button>&nbsp;\n";
		echo "				<button type=\"button\" aria-label=\"Click this button to add a new image map element to the list.\" id=\"button_add_image_area\" disabled onclick=\"DoAddImageArea()\">ADD IMAGE AREA</button>&nbsp;\n";
		echo "				<button type=\"button\" aria-label=\"Click this button to edit the name associated with the selected image map element.\" id=\"button_edit_name\" disabled onclick=\"DoEditName()\">EDIT AREA NAME</button>&nbsp;\n";
		echo "				<button type=\"button\" aria-label=\"Click this button to delete the selected image map element form the list and the selection square from the photo.\" id=\"button_delete_image_areas\" disabled onclick=\"DoDeleteImageArea()\">DELETE IMAGE AREA</button>\n";
		echo "			</td>\n";
		echo "		</tr>\n";
		echo "		<tr>\n";
		echo "			<td colspan=\"2\" style=\"text-align:center;\">\n";
		echo "				<button type=\"button\" aria-label=\"Click this button to save the selected image and the list of image map elements.\" id=\"button_create_image_map\" name=\"button_create_image_map\" disabled onclick=\"DoSubmitForm()\">CREATE NEW CLICKABLE IMAGE</button>\n";
