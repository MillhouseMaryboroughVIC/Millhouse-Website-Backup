...
<!-- #BeginTemplate "../../site_history/events/events_master.dwt" -->
	...
	<head>
		...
		<title>Events - Dungeons &Aacute; Dragons</title>
		<!-- #EndEditable -->
		...
		<div id="container">
			...
			<div class="below_masthead">
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li class="submenu_item">
								<a href="dugeons_dragons.php"><b>Dungeons &Aacute; Dragons</b></a></li>
								<li class="submenu_item">
				...
				<div class="content">
					...
					<?php 
						$g_strGroupName = "dugeons_dragons";
					...
					<form class="form" target="_self" method="post" id="login_form" style="display:<?php echo $_SESSION["display_login_form"]; ?>">
						<table cellpadding="0" cellspacing="5" border="0">
							...
							<tr>
								...
								<td><input name="password" id="password" type="passowrd"/></td>
							</tr>
							<tr>
