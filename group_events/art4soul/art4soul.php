		...
		<div id="container">
			...
			<div class="below_masthead">
				...
				<div class="navigation">
					<ul>
						...
						<li>
							...
							<ul>
								<li class="submenu_item"><a href="art4soul.php"><b>Art for Soul</b></a></li>
								...
								<li class="submenu_item">
								<a href="../u3a_writers/u3a_writers.php"><b>U3a Writers Groups</b></a></li>
							</ul>
						</li>
				...
				<div class="content">
					...
					?>
					<form class="form" target="_self" method="post" style="display:<?php echo $_SESSION["display_login_form"]; ?>">
						<table cellpadding="0" cellspacing="5" border="0" id="login_form">
							<tr>
