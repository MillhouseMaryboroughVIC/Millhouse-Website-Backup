...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	'$strType', expects a string value of 'community', 'employment', 'external_support', 'interest', 'activity', 'food', 
	...
	<p>The content of this page can be found in the file 'youth_content.html', and <b>not</b> 'youth.php'. 
	The file 'youth.php' is just a container that pulls the page contents in from the file 'youth_content.html'. So 
	you need open 'youth_content.html' in MS Expression Web.</p>
	
	<p>This has been done to make the youth page work in the mobile app, that is linked to the file 'supportm.php'. 
	This file is also just a container that pulls the page contents in from the file 'youth_content.html'.</p>
