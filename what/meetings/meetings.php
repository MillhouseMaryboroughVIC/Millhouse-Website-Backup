...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	<p><b>However</b> the content of this page can be found in the file 'meetings_content.html', and <b>not</b> 'meetings.php'. 
	The file 'meetings.php' is just a container that pulls the page contents in from the file 'meetings_content.html'. So you 
	need open 'meetings_content.html' in MS Expression Web.</p>
	
	<p>This has been done to make the meetings page work in the mobile app, that is linked to the file 'meetingsm.php'. This file 
	is also just a container that pulls the page contents in from the file 'meetings_content.html'.</p>
