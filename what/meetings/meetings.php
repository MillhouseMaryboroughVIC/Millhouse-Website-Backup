	...
	<ul>
		...
		<li style="display:<?php echo (IsAdminLoggedIn() ? "block" : "none"); ?>;">
			...
			<ul style="display:<?php echo DoShowHideSubmenu("what"); ?>;" id="contribute">
				<li class="submenu_item"><a href="meetings.php">&#x1F3AD; Community groups</a></li>
...
<?php require "meetings_content.php"; ?>
...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	<p>But also note that some of the support items do not appear as a group in the 'groups' table, e.g. NILs loans and 
	room hire. They have to be manually coded in HTML.</p>
	
	<h1>PC &amp; Mobile versions of this page</h1>
	<p>The content of this page can be found in the file 'meetings_content.html', and <b>not</b> 'meetings.php'. 
	The file 'meetings.php' is just a container that pulls the page contents in from the file 'meetings_content.html'. So 
	you need open 'meetings_content.html' in MS Expression Web.</p>
	
	<p>This has been done to make the meetings page work in the mobile app, that is linked to the file 'supportm.php'. 
	This file is also just a container that pulls the page contents in from the file 'meetings_content.html'.</p>
