...
<ul>
	<li><a href="#computers">Desktop and laptop computers</a></li>
	<li><a href="#borrow">Need to borrow a laptop?</a></li>
	<li><a href="#wifi">FREE WiFi Access</a></li>
	<li><a href="#printing">Printing &amp; scanning services</a></li>
	<li><a href="#accessibility">Accessibility</a></li>
	<li><a href="#problems">Software, operating system or device problems?</a></li>
	<li><a href="#meetings">Need a meeting room?</a></li>
</ul>
...
<h1 id="computers">Desktop and laptop computers</h1>

<p>Desktop computers x 4.</p>
<p>Laptop computers x 4.</p>

<ul>
	<li><b>Operating system: </b>MS Windows 10</li>
	<li><b>Software: </b>Libre Office (compatible with MS Office)</li>
	<li><b>Web browsers: </b> Google chrome, Mozilla Firefox, Ms Edge, Opera.</li>
	<li><b>Email client: </b> Mozilla Thunderbird.</li>
</ul>

<p>Other software can be installed on an as needed basis.</p>

<p><b>PLEASE NOTE: </b>Do not save any private personal data on the hard drives because anyone else using the 
computer will potentially be able to view it. Save private personal data on you own USB thumb 
drive or external hard drive.</p>

<p>
	<a href="images/ThumbDrive.jpg"><img src="images/ThumbDrive.jpg" alt="ThumbDrive.jpg" height="200" /></a>&nbsp;
	<a href="images/ExternalDrive.jpg.jpg"><img src="images/ExternalDrive.jpg" alt="ExternalDrive.jpg" height="200" /></a>
</p>

<p>If you are unsure how to do this then please ask one of our digital mentors to show 
you how.</p>
...
<h1 id="borrow">Need to borrow a laptop?</h1>

<p>Don’t have access to a computer at home?</p>

<p>Is your laptop of desktop being repaired or upgraded?</p>

<p>Mill House has laptops available for community members to borrow for short-term use 
at home.</p>

<p>Please ask at the reception desk.</p>

<p>And once again, please <b>DO NOT</b> save any personal provate data on the internal 
hard drive. Because the next person who uses the laptop can potentially read it.</p>

<p>Save your perosnal private data on your own USB thumb drive or external USB hard 
drive.</p>
...
<p>If you don't know how to do this then please ask at reception and one of our digital 
mentors will show you how.</p>

<p><a href="#top">Top</a></p>
								
<!--#########################################################################################################-->

<h1 id="wifi">FREE WiFi Access</h1>

<p>Stay connected with your community and the online world at Mill House. Bring along 
your own laptop or tablet and use our Wi-Fi to access Centrelink, pay bills, complete 
school or study assignments, apply for jobs, manage online services, attend online 
appointments or simply browse the internet and social media.</p>

<p>Whether you need to get something important done or just need a place to connect, 
Mill House provides a friendly, welcoming space where everyone is encouraged to get 
online and stay connected.</p>

<p><a href="#top">Top</a></p>
								
<!--#########################################################################################################-->

<h1 id="printing">Printing &amp; scanning services</h1>

<p>Need to scan or print an important document? Mill House has a colour laser printer 
and flatbed scanner available for community use.</p>

<p>You can bring along documents that you need to scan and submit to Centrelink or 
other government and service providers. We can also help with limited printing of your 
personal documents, forms, information sheets and flyers.</p>

<p>It’s another way Mill House can help make everyday tasks a little easier.</p>
...
<p>Windows 10 has the following accessibility features:</p>

<ul>
	<li>
		<b>Magnifier: </b>enlarges items or your entire screen so text and images are  
		easier to see.
	</li>
	<li>
		<b>Narrator: </b>a built-in screen reader that reads aloud text on your screen 
		and describes events.
	</li>
	<li>
		<b>Color Filters: </b>changes screen colors to help users with color blindness (such 
		as deuteranopia or protanopia) or light sensitivity.
	</li>
	<li>
		<b>High Contrast: </b>applies high-contrast color themes to make text and apps stand 
		out clearly.
	</li>
	<li>
		<b>Text and Cursor Size: </b>adjusts text scaling across the system and changes the 
		size or color of the mouse pointer. 
	</li>
	<li>
		<b>Mono Audio: </b>combines stereo channels into a single mono track so you hear all 
		sound even with one earphone or hearing loss in one ear.
	</li>
	<li>
		<b>Visual Notifications: </b>flashes the active window or the screen to give a visual 
		cue when an audio alert goes off.
	</li>
	<li>
		<b>Closed Captions: </b>customizes how subtitles and captions appear in supported apps 
		and videos. 
	</li>
	<li>
		<b>Speech Recognition: </b>lets you control your PC using only your voice.
	</li>
	<li>
		<b>On-Screen Keyboard: </b>allows you to type by clicking an interactive virtual 
		keyboard with a mouse or touch input.
	</li>
	<li>
		<b>Sticky Keys and Filter Keys: </b>simplifies complex keyboard shortcuts (like Ctrl + 
		Alt + Delete) by letting you press keys one at a time.
	</li>
	<li>										
		<b>Mouse Keys: </b>lets you move and control the mouse cursor using your numeric keypad.
	</li>
</ul>

<p>If you need help using these features, one of our friendly digital mentors can assist 
you with turning them on and adjusting them to suit your needs.</p>
						
<p>We can also project your computer screen onto a larger TV screen. This can be 
particularly helpful if you find the built-in screen magnifier difficult to use or 
simply need a larger view of what is on your screen.</p>

<p><img src="images/WindowsTV.jpg" alt="WindowsTV.jpg" height="200" /></p>

<p>One of our digital mentors will help you set this up.</p>

<p><a href="#top">Top</a></p>
								
<!--#########################################################################################################-->

<h1 id="problems">Software, operating system or device problems?</h1>

<p>Need a hand with something online? Our friendly digital mentors are here to help you 
solve problems, learn new skills, access online services, build new skills and make 
everyday technology a little easier.</p>

<p>If they don’t know the answer straight away, that’s okay. They’ll do their best to 
find out how to help and, where necessary, arrange for you to come back to Mill House so 
they can continue helping you.</p>
					
<p><a href="#top">Top</a></p>
								
<!--#########################################################################################################-->

<h1 id="meetings">Need a meeting room?</h1>

<h2>Group meetings</h2>

<p>We have a meeting room with conference camer equipment for online meetings, video calls 
and hybrid meetings.</p>

<p><a href="../../room/images/boardroom.jpg"><img src="../../room/images/boardroom.jpg" alt="boardroom.jpg" height="200" /></a></p>

<p>You will need to book the room so please ring Mill House or ask at the reception desk to 
book the conference room. Or you can inquire about booking a room <a href="../../room/room.php#book_a_room">here</a>.</p>

<h2>Individual meetings</h2>

<p>We also have some small private offices where you can conduct personal meetings such as 
video calls with family members, friends and colleagues. Or online meetings with medical 
professionals, employers, Centrelink or job service providers.</p>

<p>
	<a href="../../room/images/office1.jpg"><img src="../../room/images/office1.jpg" alt="office1.jpg" height="200" /></a>&nbsp;
	<a href="../../room/images/office2.jpg"><img src="../../room/images/office2.jpg" alt="office2.jpg" height="200" /></a>&nbsp;
	<a href="../../room/images/front_loungeroom.jpg"><img src="../../room/images/front_loungeroom.jpg" alt="front_loungeroom.jpg" height="200" /></a>
</p>

<p>If required our digital mentors can install and set up WhatsApp and WeChat etc. on the laptops or 
desktops so that your call will cost you nothing.</p>
