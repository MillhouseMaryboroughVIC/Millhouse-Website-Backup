...
<?php require "digital_content.php"; ?>
...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	<p><b>However</b> the content of this page can be found in the file 'digital_content.html', and <b>not</b> 'digital.php'. 
	The file 'digital.php' is just a container that pulls the page contents in from the file 'digital_content.html'. So you 
	need open 'digital_content.html' in MS Expression Web.</p>
	
	<p>This has been done to make the digital page work in the mobile app, that is linked to the file 'digitalm.php'. This file 
	is also just a container that pulls the page contents in from the file 'digital_content.html'.</p>
