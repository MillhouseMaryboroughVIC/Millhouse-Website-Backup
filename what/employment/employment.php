	...
	<ul>
		...
		<li style="display:<?php echo (IsAdminLoggedIn() ? "block" : "none"); ?>;">
			...
			<ul style="display:<?php echo DoShowHideSubmenu("what"); ?>;" id="contribute">
				...
				<li class="submenu_item"><a href="employment.php">&#x1F477; Employment services</a></li>
...
<?php require "employment_content.php"; ?>
...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	<p><b>However</b> the content of this page can be found in the file 'employment_content.html', and <b>not</b> 'employment.php'. 
	The file 'employment.php' is just a container that pulls the page contents in from the file 'employment_content.html'. So you 
	need open 'employment_content.html' in MS Expression Web.</p>
	
	<p>This has been done to make the employment page work in the mobile app, that is linked to the file 'employmentm.php'. This file 
	is also just a container that pulls the page contents in from the file 'employment_content.html'.</p>
