...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	<p>The content of this page can be found in the file 'support_content.html', and <b>not</b> 'support.php'. 
	The file 'support.php' is just a container that pulls the page contents in from the file 'support_content.html'. So 
	you need open 'support_content.html' in MS Expression Web.</p>
	
	<p>This has been done to make the support page work in the mobile app, that is linked to the file 'supportm.php'. 
	This file is also just a container that pulls the page contents in from the file 'support_content.html'.</p>
