...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	<p>The content of this page can be found in the file 'food_content.html', and <b>not</b> 'food.php'. 
	The file 'food.php' is just a container that pulls the page contents in from the file 'food_content.html'. So 
	you need open 'food_content.html' in MS Expression Web.</p>
	
	<p>This has been done to make the food page work in the mobile app, that is linked to the file 'supportm.php'. 
	This file is also just a container that pulls the page contents in from the file 'food_content.html'.</p>
