...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<style type="text/css">
			...
			input[type=checkbox],.checkboxes label
			{
...
<ul>
	<li>Help Millhouse help those who are struggling</li>
	<li>Build social confidence</li>
	<li>Improve your physical &amp; mental health</li>
	<li>Alleviate loneliness</li>
	<li>Gain work experience for paid jobs</li>
	<li>Gain a sense of personal fullfillment</li>
	<li>Networking opportunities</li>
	<li>Satisfy Centrelink requirements</li>
</ul>

<form target="_self" method="post" class="form" style="width:590px;">
	<h1>I'd like to volunteer</h1>
	<table border="0" cellpadding="0" cellspacing="5">
		<tr>
			<td style="text-align:right;"><label for="preferred">Preferred day(s):</label></td>
			<td>
				<table border="0" cellpadding="0" cellspacing="0" class="checkboxes">
					<tr>
						<td style="text-align:right;"><input type="checkbox" name="monday" id="monday" /></td>
						<td><label for="monday">Monday</label></td>
						<td style="text-align:right;"><input type="checkbox" name="tuesday" id="tuesday" /></td>
						<td><label for="tuesday">Tuesday</label></td>
						<td style="text-align:right;"><input type="checkbox" name="wednesday" id="wednesday" /></td>
						<td><label for="wednesday">Wednesday</label></td>
						<td style="text-align:right;"><input type="checkbox" name="thursday" id="thursday" /></td>
						<td><label for="thursday">Thursday</label></td>
						<td style="text-align:right;"><input type="checkbox" name="friday" id="friday" /></td>
		...
		<tr>
			<td style="text-align:right;"><label for="start_time">Start time:</label></td>
			<td><input type="time" id="start_time" name="start_time" step="60" required/></td>
		</tr>
		<tr>
			<td style="text-align:right;"><label for="text_hours">Number of hours:</label></td>
			<td><input type="text" value="1" id="text_hours" name="text_hours" style="max-width:50px;" onkeypress="OnKeyPressDigitsOnly(event)" required />&nbsp;hr(s)</td>
		</tr>
		<tr>
			<td style="text-align:right;"><label for="text_name">Name:</label></td>
			<td><input type="text" id="text_name" name="text_name" onkeypress="OnKeyPressName(event)" required /></td>
		</tr>
		<tr>
			<td style="text-align:right;"><label for="text_email">Email address:</label></td>
			<td><input type="text" id="text_email" name="text_email" onkeypress="OnKeyPressEmailAddress(event)" required /></td>
		</tr>
		<tr>
			<td style="text-align:right;"><label for="text_phone">Phone number:</label></td>
			<td><input type="text" id="text_phone" name="text_phone" onkeypress="OnKeyPressPhone(event)" required /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2"><h3><?php echo DoProcessFormData(); ?></h3></td>
		</tr>
	</table>
</form>
