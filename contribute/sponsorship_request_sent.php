...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Sponsorship Request Sent</title>
		<style type="text/css">
</style>
...
<?php
	...
	$_SESSION["text_your_name"] = $_POST["text_your_name"];
	$_SESSION["text_phone"] = $_POST["text_phone"];
	$_SESSION["text_email"] = $_POST["text_email"];
	
	$strSuccessDisplay = "none";
	$strFailureDisplay = "none";
	
	if (isset("button_request_sponsorship"))
	{
		
		$strMessage = "BUSINESS NAME: " . $_POST["text_business_name"] . "\r\n" . 
						"BUSINESS WEBSITE: " . $_POST["text_website"] . "\r\n" .
						"CONTACT NAME: " . $_POST["text_your_name"] . "\r\n" .
						"PHONE: " . $_POST["text_phone"] . "\r\n" .
						"EMAIL: " . $_POST["text_email"] . "\r\n" .
						"LOGO URL: " . $_POST["text_logo_url"];

		
		if (mail($g_strEmailManager, "SPONSORSHIP REQUEST", $strMessage, "From: " . $_POST["text_your_name"] . "<" . $_POST["text_email"] . ">\r\nReply-To: " . $_POST["text_email"] . "\r\n"))
		{
			$strSuccessDisplay = "block";
		}
		else
		{
			$strFailureDisplay = "block";
		}
	}
?>

<div style="display:<?php echo $strSuccessDisplay; ?>">

	<p><b>Your sponsorship request has been sent to the Mill House manager.</b></p>
	<p>If you request is approved the manager will contact you and arrange payment. You advert will be activated with and 
	expiry date. When the expiry date passes then your advert will not longer be displayed. Contact the manager if you wish 
	to extend your advert before it expires.</p>
	
</div>
<div style="display:<?php echo $strFailureDisplay; ?>">
	<p><b>Your sponsorship request could not be sent to the Mill House manager. Please go back to the previous page and try again, 
	or copy your advery HTML and email the manager yourself.</b></p>
</div>
...
<div id="div_page_edit_instructions" class="instruction_popup">
	...
	<p>ALL the contents of this page is just plain HTML and CSS, except for some PHP code that processes the contents of the 
	form on the 'request_sponsorship.php' web page. But please do not edit the contents of this page unless you are an 
	expert.</p>
