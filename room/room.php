...
<div id="div_navigation_menu" class="navigation_menu">
	...
	<ul>
		...
		<li><a href="room.php">&#x1F3E8; Room hire</a></li>
...
<div class="rooms_4_hire">
	<script type="text/javascript">
		...
		for (let nI = 0; nI < g_arrayHireRoom.length; nI++)
		{
			...
			document.write("</ul>\n");
			document.write("<p>\n");
			document.write("    <a href=\"images/" + g_arrayHireRoom[nI].strImageFilename1 + "\"><img class=\"content_img\" src=\"images/" + g_arrayHireRoom[nI].strImageFilename1 + "\" alt=\"" + g_arrayHireRoom[nI].strImageFilename1 + "\" /></a>&nbsp;\n");
			if (g_arrayHireRoom[nI].strImageFilename2 != "")
				document.write("    <a href=\"images/" + g_arrayHireRoom[nI].strImageFilename2 + "\"><img class=\"content_img\" src=\"images/" + g_arrayHireRoom[nI].strImageFilename2 + "\" alt=\"" + g_arrayHireRoom[nI].strImageFilename2 + "\" /></a>;\n");
			document.write("<p>\n");
			document.write("<p>\n");
			if (g_arrayHireRoom[nI].strImageFilename3 != "")
				document.write("    <a href=\"images/" + g_arrayHireRoom[nI].strImageFilename3 + "\"><img class=\"content_img\" src=\"images/" + g_arrayHireRoom[nI].strImageFilename3 + "\" alt=\"" + g_arrayHireRoom[nI].strImageFilename3 + "\" /></a>&nbsp;\n");
			if (g_arrayHireRoom[nI].strImageFilename4 != "")
				document.write("    <a href=\"images/" + g_arrayHireRoom[nI].strImageFilename4 + "\"><img class=\"content_img\" src=\"images/" + g_arrayHireRoom[nI].strImageFilename4 + "\" alt=\"" + g_arrayHireRoom[nI].strImageFilename4 + "\" /></a>&nbsp;\n");
			document.write("</p>\n");
		}
...
<h1 id="book_a_room">Book a Room</h1>	
