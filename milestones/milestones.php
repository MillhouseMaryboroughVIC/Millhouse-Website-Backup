	...
	<ul>
		...
		<li>
			...
			<ul style="display:<?php echo DoShowHideSubmenu("about"); ?>;" id="about">
				...
				<li class="submenu_item"><a href="milestones.php">&#x1F3C6; Milestones</a></li>
...
<p><b>Any noteable upcoming or past events or acheivements you want visitors to know about. Examples below.</b></p>

<h1>Mill House appoints a new manager 1/9/2025</h1>
<table border="0" cellpadding="5" cellspacing="0">
	<tr>
		<td style=""><img src="images/MakingCupCakes.jpg" alt="MakingCupCakes.jpg" height="250" style="float:left;"/></td>
		<td style="width:1100px;">
			<p>Sarah McLean became the new Coordinator/Manager following a leadership transition in late 2025. Sarah is 
			native Maryboroughan who is dedicated to making her town, and wider central goldfields region community, a 
			better place for all its residents. As Mill House's new manager she is endeavoring to build on Michelle 
			Baker's good work by securing new grants and donations in order to extend Mill House's exiting programs, 
			and initiate new ones.</p>
			<p>Sarah is particularly focused on programs that will benefit young Maryboroughans.</p>
		</td>
	</tr>
</table>
<table border="0" cellpadding="5" cellspacing="0">
	<tr>
		<td style="width:1100px;">
			<p>She takes over from long-term coordinator Michelle Baker (long grey dress), who departed in September 
			2025. Four years ago, Ms Baker started as the organisation’s coordinator turning the struggling Goldfields 
			Employment and Learning Centre into a community-focused organisation. From lunch on a Friday, to their 
			weekly market, and opening their doors for other organisations the neighbourhood house has become a 
			celebration of community spirit. It’s a success story Ms Baker said is a team effort alongside Sarah McLean, 
			her assistant over her 4 year tenure as manager.</p>
			<p>"I feel like I’ve given the very best of me to 
			this role ... it’s the perfect time to hand over to Sarah because it’s humming, but that wasn't always the 
			case. We’ve evolved to the voice of the community.The organisation originally focused on classes, but the 
			community weren’t interested, so they voted with their feet. Anything that anyone came to we’d keep 
			trialling to do more of that in the hopes it’d catch on. Community is the basis for human existence.”</p>	
		</td>
		<td style=""><img src="images/MichelleBaker.jpg" alt="MichelleBaker.jpg" height="250" style="float:right;"/></td>
	</tr>
</table>
<h1 id="mural">Mill House gets a new look</h1>	
<table border="0" cellpadding="5" cellspacing="0">
	<tr>
		<td style="">
			<img src="images/Mural.jpg" alt="Mural.jpg" height="150" style="float:left;"/>
			<p style="font-size:xx-small;">Volunteers Kay Cameron, Cathy Schwagger &amp; Emily Sutton, with manager Sarah McLean (red blowse).</p>
		</td>
		<td style="width:1100px;">
			<p>Mill House engaged a art studen Tarah, from Maryborough Education Centre, to paint a mural on the wall of 
			 the the entrance hallway. Mill House is a great place for young Maryboroughans to hang-out, make friends and 
			 contribute to the Mill House community by showing off their unique talents.</p>
		</td>
	</tr>
</table>
