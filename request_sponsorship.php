...
?>
<p>&nbsp;</p>
<form class="form" id="edit_advert_form" method="post" target="_self" action="sponsorship_request_sent.php">
...
<!--
		<tr>
			<td style=" "><label for="select_advert_slot">Select your preferred sponsorship slot</label></td>
		</tr>
		<tr>
			<td>
				<select id="select_advert_slot" name="select_advert_slot" style="width: 20ch;">
					<?php echo DoGetAdvertSlotOptions($strAdvertSlotID); ?>
				</select>
			</td>
		</tr>
-->
...
-->
		<tr>
			<td><button type="submit" name="button_request_advert">SEND REQUEST</button></td>
		</tr>
	</table>
</form>
