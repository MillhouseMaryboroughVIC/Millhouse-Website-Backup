	...
	<ul>
		...
		<li>
			...
			<ul style="display:<?php echo DoShowHideSubmenu("governance"); ?>;" id="governance">
				...
				<li class="submenu_item">
				<a href="rules.php" tabindex="0" onfocus="DoSpeakElement(this)" onmouseenter="DoSpeakElement(this)"><b>Rules</b></a></li>
				<li class="submenu_item">
...
<iframe src="MHRulesOfAssociation.pdf" width="100%" height="10000px" style="border:none;"></iframe>
