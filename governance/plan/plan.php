	...
	<ul>
		...
		<li>
			...
			<ul style="display:<?php echo DoShowHideSubmenu("governance"); ?>;" id="governance">
				...
				<li class="submenu_item">
				<a href="plan.php" tabindex="0" onfocus="DoSpeakElement(this)" onmouseenter="DoSpeakElement(this)"><b>Strategic Plan</b></a></li>
			</ul>
		</li>
		<li>
...
<iframe src="StrategicPlan.pdf" width="100%" height="500px" style="border:none;"></iframe>
