	...
	<ul>
		...
		<li>
			...
			<ul style="display:<?php echo DoShowHideSubmenu("governance"); ?>;" id="governance">
				...
				<li class="submenu_item">
				<a href="policies/policies.php" tabindex="0" onfocus="DoSpeakElement(this)" onmouseenter="DoSpeakElement(this)"><b>Policies</b></a></li>
				<li class="submenu_item">
...
<p>Goldfields Education &amp; Learning Center trading as Mill House Neighborhood House</p>

<h1>Committee Members</h1>
<ul>
	<li><b>President: </b>John Williamson</li>
	<li><b>Vice President: </b>Reyne Canning</li>
	<li><b>Treasurer: </b>Patricia Rainbow</li>
	<li><b>Secretary: </b>Samantha Redlich</li>
	<li><b>Ordinary Members: </b>
		<ul>
			<li>Cathy Schwager</li>
			<li>Dianne Parsons</li>
			<li>Shaun Talbot</li>
			<li>Mollie Mason</li>
		</ul>
	</li>
...
<ul>
	<li><a href="https://www.acnc.gov.au/charity/charities/a49d2dd7-2daf-e811-a960-000d3ad24282/profile"><b>ACNC Listing</b></a></li>
	<li><a href="rules/rules.php"><b>Association Rules</b></a></li>
	<li><a href="plan/plan_rules.php"><b>Strategic Plan</b></a></li>
	<li><a href="reports/reports.php"><b>Annual Reports</b></a></li>
	<li><a href="policies/policies.php"><b>Policies</b></a></li>
	<li><a href="forms/forms.php"><b>Blank Forms</b></a></li>
</ul>
