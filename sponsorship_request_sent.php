...
<?php
	...
	$_SESSION["select_advert_slot"] = $_POST["select_advert_slot"];
	$_SESSION["textarea_design"] = $_POST["textarea_design"];
	
	$strSuccessDisplay = "none";
	$strFailureDisplay = "none";
	
	if (isset("button_request_advert"))
	{
		$strAdvertHTML = $_POST["textarea_design"];
		
		$nPos1 = 0;
		do
		{
			$strAdvertHTML = DoRemoveScriptTags($strAdvertHTML);
			str_replace("\n", "", $strAdvertHTML);
			str_replace("\r", "", $strAdvertHTML);
		}
		while ($nPos1 > -1);
		...
		$strMessage = "BUSINESS NAME: " . $_POST["text_business_name"] . "\r\n" . 
						...
						//"ADVERT SLOT ID: " . $_POST["select_advert_slot"] . "\r\n" .
						//"ADVERT HTML: \r\n\r\n" . $strAdvertHTML;
						"LOGO URL: " . $_POST["text_logo_url"];

		
		if (mail($g_strEmailManager, "ADVERT REQUEST", $strMessage, "From: " . $_POST["text_your_name"] . "<" . $_POST["text_email"] . ">\r\nReply-To: " . $_POST["text_email"] . "\r\n"))
		{
...
<div style="display:<?php echo $strSuccessDisplay; ?>">
	...
	<p><b>Your advert request has been sent to the Mill House manager.</b></p>
...
<div style="display:<?php echo $strFailureDisplay; ?>">
	<p><b>Your advert request could not be sent to the Mill House manager. Please go back to the previous page and try again, 
