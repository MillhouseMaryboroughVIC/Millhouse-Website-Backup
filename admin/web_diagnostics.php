...
*/
	...
	if (isset($_POST["submit_ban_keyword"]))
	{
		...
		try
		{
			...
			PrintJavascriptLine("alert(\"" . $_POST["text_keyword"] . " was successfully added to 'robots.txt'...\")", 1, true);
		}
		catch (Exception $e)
		{
...
<div class="user_agent_popup" id="div_user_agent_popup">
	<h1 id="user_agent_popup_heading" class="event_popup_heading">USER AGENT STRING</h1>
	<p id="user_agent_popup_details"></p>
