		...
		XXXXX	
						...
						<td style="vertical-align:top;">
							...
							<div class="content" id="div_content">
								...
								<form class="form_voice_assist_button"><button type="button" aria-label="Show the voice assist settings." onclick="DoDisplayHidePopup('form_voice_assist', true)"><img src="images/LoudSpeaker.png" alt="LoudSpeaker.png" height="70" aria-label="Click this button to show the voice assist settings." /></button></form>

								<!-- #BeginEditable "CustomContent" -->

<h1>Who We Are</h1>

<p style="font-size:x-large;"><b>WELCOME TO MILL HOUSE</b></p>

<a href="about/images/feast.jpg" style="position:relative;float:right;"><img src="about/images/feast.jpg" alt="feast.jpg" height="200" /></a>

<p>A welcoming community space in the heart of Maryborough.</p>

<p>Mill House Neighbourhood House is a place where people come together, connect and belong. We provide a friendly, 
inclusive space for people of all ages and backgrounds to meet others, share skills, enjoy activities, access support 
and take part in community life.</p>

<p>As a local community organisation and charity, Mill House is here for everyone — whether you want to make new 
friends, learn something new, volunteer your time, enjoy a meal, join an activity, access community services or simply 
drop in for a chat.</p>

<p>We believe strong communities are built on connection, participation and looking out for one another. Mill House 
provides opportunities for people to contribute, build confidence, develop skills and feel part of the Maryborough 
community.</p>

<a href="images/KayCathySarahMural.jpg" style="position:relative;float:left;margin-right:10px"><img src="images/KayCathySarahMural.jpg" alt="KayCathySarahMural.jpg" height="200" /></a>

<p>We bring people together, provide practical support and create opportunities for people of all ages and backgrounds 
to connect, learn and participate. And we provide practical support for individuals and families across the Central 
Goldfields.</p>

<p>Everyone is welcome at Mill House, regardless of age, ability, background or circumstances.</p>

<p>Our aim is to help people feel connected, supported and involved in their local community.</p>

<p>Come in, get involved and be part of Mill House.</p>

<p>&nbsp;</p>

<h2>Our staff and volunteers</h2>
