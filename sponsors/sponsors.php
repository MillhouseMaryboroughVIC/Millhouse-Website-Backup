...
<div id="div_navigation_menu" class="navigation_menu">
	...
	<ul>
		...
		<li>
		<a href="sponsors.php" tabindex="0" onfocus="DoSpeakElement(this)" onmouseenter="DoSpeakElement(this)">Our Collaborators</a></li>
		<li>
		...
		if ($result && ($result->num_rows > 0))
		{
			while ($row = $result->fetch_assoc())
			{
				...
				if ($datetimeExpiry >= $datetimeNow)
				{
					...
					echo "<p><img src=\"images/" . $row["logo_image"] . "\" alt=\"" . $row["logo_image"] . "\" /></p>\n";
